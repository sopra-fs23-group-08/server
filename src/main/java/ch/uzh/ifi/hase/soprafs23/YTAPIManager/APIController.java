...
class APIController {
    ...
    private static Pair<VideoData, List<Hand>> getGameDataFromVidsAndComments(//long and messy function :(
            List<Pair<VideoList.Item, List<CommentList.Item>>> listOfVidsAndComments) throws IllegalStateException, IOException, InterruptedException {
    ...
    static CommentList fromJsonToCommentList(String jsonString) throws IllegalStateException {
